...
object PlaybackContract {
    ...
    data class State(
        ...
        val selectedQualityGroupIndex: Int? = null,
        val selectedQualityTrackIndex: Int? = null,
        val selectedAudioLabel: String = "",
        val selectedAudioGroupIndex: Int? = null,
        val selectedAudioTrackIndex: Int? = null,
        val selectedCaptionLabel: String = "Off",
        val selectedCaptionGroupIndex: Int? = null,
        val selectedCaptionTrackIndex: Int? = null,
